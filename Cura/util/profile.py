...
setting('use_youmagine', 'True', bool, 'preference', 'hidden').setLabel(_("Enable YouMagine uploads"), _("Show icon and menu entries for YouMagine (Requires a restart)"))
...
setting('relative_extrusion', 'False', bool, 'machine', 'hidden').setLabel(_("Relative Extrusion"), _("Use relative E values for Gcode output."))
